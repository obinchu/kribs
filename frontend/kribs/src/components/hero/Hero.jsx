...
const Hero = () => {
  return (
    <div className="flex flex-col  bg-white justify-center w-full h-[75vh]">
      ...
      style={{
        backgroundImage: `url('https://3edb-102-218-124-142.ngrok-free.app/house1.jpg')`,
      }}>
         ...
         <div className="flex w-[50%] h-[20%] mx-auto transform translate-y-16 rounded bg-transparent">
          <QuickSearch />
          </div>
    </div>
  );
